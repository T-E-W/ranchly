...
import { Beef, Plus, ArrowRight } from 'lucide-react'
    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Track and manage your herd groups</p>
        </div>
        <Link
          href="#"
      ...
      <div className="bg-white rounded-2xl border border-[#e2ddd5] p-16 text-center">
        <div className="w-16 h-16 rounded-2xl bg-[#3a6b35]/10 flex items-center justify-center mx-auto mb-5">
          <Beef className="w-8 h-8 text-[#3a6b35]" />
        </div>
        <h2
        ...
        <ul className="text-sm text-gray-500 space-y-1 mb-8 max-w-sm mx-auto text-left">
          <li className="flex items-start gap-2"><ArrowRight className="w-4 h-4 text-[#3a6b35] mt-0.5 shrink-0" /> Organize animals into groups by breed, age, and purpose</li>
          <li className="flex items-start gap-2"><ArrowRight className="w-4 h-4 text-[#3a6b35] mt-0.5 shrink-0" /> Log births, deaths, purchases, and sales</li>
          <li className="flex items-start gap-2"><ArrowRight className="w-4 h-4 text-[#3a6b35] mt-0.5 shrink-0" /> Track weights, health events, and treatments</li>
          <li className="flex items-start gap-2"><ArrowRight className="w-4 h-4 text-[#3a6b35] mt-0.5 shrink-0" /> Monitor pasture assignments and moves</li>
        </ul>
        <Link
          href="#"
