    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Track maintenance and operating costs</p>
        </div>
        <Link
          href="#"
      ...
      <div className="bg-white rounded-2xl border border-[#e2ddd5] p-16 text-center">
        <div className="w-16 h-16 rounded-2xl bg-[#3a6b35]/10 flex items-center justify-center mx-auto mb-5">
          <Wrench className="w-8 h-8 text-[#3a6b35]" />
        </div>
        <h2
        ...
        <ul className="text-sm text-gray-500 space-y-1 mb-8 max-w-sm mx-auto text-left">
          <li className="flex items-start gap-2"><ArrowRight className="w-4 h-4 text-[#3a6b35] mt-0.5 shrink-0" /> Catalog all machinery and vehicles on your operation</li>
          <li className="flex items-start gap-2"><ArrowRight className="w-4 h-4 text-[#3a6b35] mt-0.5 shrink-0" /> Set maintenance schedules and receive reminders</li>
          <li className="flex items-start gap-2"><ArrowRight className="w-4 h-4 text-[#3a6b35] mt-0.5 shrink-0" /> Log repairs, parts, and service history</li>
          <li className="flex items-start gap-2"><ArrowRight className="w-4 h-4 text-[#3a6b35] mt-0.5 shrink-0" /> Track total cost of ownership per machine</li>
        </ul>
        <Link
          href="#"
